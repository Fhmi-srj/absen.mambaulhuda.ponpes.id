...
<head>
    ...
    <title>Cetak Kartu Santri ({{ count($siswaList) }} Kartu)</title>
...
<body>
    <div class="print-header">
        <h4><i class="fas fa-id-card"></i> Cetak {{ count($siswaList) }} Kartu Santri</h4>
        <button class="btn-print" onclick="window.print()">🖨️ Cetak Sekarang</button>
        <button class="btn-close-page" onclick="window.close()">✕ Tutup</button>
    </div>

    <div class="cards-container">
        @foreach($siswaList as $siswa)
            @php $qrApiUrl = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" . urlencode($siswa->nisn ?? $siswa->id); @endphp
            <div class="id-card">
                ...
                <div class="card-body">
                    ...
                    <div class="info-section">
                        ...
                        <div class="student-nis">{{ substr($siswa->nisn ?? '------', 0, 6) }}</div>
